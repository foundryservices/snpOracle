...
from oracle.utils.bittensor import print_info, setup_bittensor_objects
...
class Miner:
    ...
    def __init__(self, config=None):
        ...
        config = Config(args)
        self.forward_module = importlib.import_module(f"oracle.miners.{config.forward_function}", package="forward")
        self.config = config
    ...
    async def forward(self, synapse: Challenge) -> Challenge:
        ...
        synapse = self.forward_module.forward(self, synapse)
